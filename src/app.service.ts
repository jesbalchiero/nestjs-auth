...
export class AppService {
  ...
  getProjectInfo(): string {
    return `
      ...
      <p>Foi implementado utilizando as melhores práticas de segurança e boas práticas de Typescript, além de integração com Prisma para manipulação do banco de dados MySQL.</p>
      ...
      <p>It has been implemented using best security practices and Typescript best practices, along with integration with Prisma for MySQL database manipulation.</p>
